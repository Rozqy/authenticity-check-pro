        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
          ...
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-yellow-900 mb-1">Image-Only Verification is Limited</h3>
          ...
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-red-50 border border-red-200 rounded-lg">
            <h3 className="text-sm font-medium text-red-900 mb-2 sm:mb-3">
              Codes Visible in Image <span className="text-red-600">*</span> (REQUIRED for Fake Detection)
            </h3>
            <p className="text-xs sm:text-sm text-red-800 mb-3 sm:mb-4 font-medium leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-3 py-2 sm:py-2 text-sm border border-red-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-3 py-2 sm:py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            </div>
          </div>
