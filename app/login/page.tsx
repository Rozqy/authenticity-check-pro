...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-12">
        {/* Logo */}
        <div className="text-center mb-4 sm:mb-8">
          <Link href="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-xl sm:text-2xl font-bold text-gray-900">Authenticity Check Pro</span>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm mb-4 sm:mb-6">
          <div className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 px-3 sm:px-4 py-2.5 sm:py-3 text-sm font-medium text-center ${
                activeTab === 'login'
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:p-8">
          {activeTab === 'login' && (
            <>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-2">Sign In</h1>
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Enter your credentials to access your account.</p>
              ...
              <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center px-4 py-2.5 sm:py-3 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50"
                >
